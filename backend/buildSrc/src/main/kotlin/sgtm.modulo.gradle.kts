...
// plugin de Spring Boot: solo kamayuk-normativa-aplicacion produce un artefacto ejecutable.
...
dependencies {
    ...
    // SET LOCAL). Vive en kamayuk-normativa-plataforma, que declara `api` sobre
