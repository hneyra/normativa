package kamayuk.normativa.parametros;

import java.util.Objects;
import kamayuk.normativa.dominio.Ejercicio;
import kamayuk.normativa.dominio.PoliticasDeRedondeo;
import kamayuk.normativa.reglas.ParametroSinPublicar;
import kamayuk.normativa.reglas.PoliticasDeRedondeoSelladas;
import kamayuk.normativa.web.CodigoDeError;
import kamayuk.normativa.web.ParametroQueFalta;
 ...
 *
 * <h2>Por que vive en {@code kamayuk-normativa-parametros}</h2>
 *
 * <p>Porque es el unico modulo que puede nombrar a la vez las dos mitades: {@link
 * ParametroSinPublicar} —suyo— y {@link ProblemaDeNegocio} de {@code kamayuk-normativa-plataforma},
 * del que todo contexto depende. Al reves no se puede: {@code kamayuk-normativa-plataforma} es la
 * base del grafo y no depende de ningun contexto acotado, asi que {@code kamayuk.normativa.web} no
...
public final class FaltaPublicar {
     ...
     * kamayuk.normativa.dominio.Ejercicio} fuera de rango, sale como {@code
     ...
     * kamayuk-normativa-dominio-compartido} y no sabe de que ejercicio salieron las politicas —no
