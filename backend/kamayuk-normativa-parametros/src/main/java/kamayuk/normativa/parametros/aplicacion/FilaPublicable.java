 ...
 * TUO del Codigo Tributario dice «cuatro (4) anios» y {@link
 * kamayuk.normativa.dominio.Plazo#de(String)} solo acepta «4 ANIOS», porque rechaza a proposito
 * toda lectura tolerante —un plazo interpretado «lo mejor posible» es plausible y equivocado, que
 * es el modo de falla que nadie detecta—. Las dos exigencias no caben en una columna: {@code
 * valor_texto} es la transcripcion verbatim, que {@code verificar-publicacion.mjs} compara letra
 * por letra contra el corpus, y {@code valor_maquina} es lo que se publica en su lugar cuando la
 * fila la trae.
 *
