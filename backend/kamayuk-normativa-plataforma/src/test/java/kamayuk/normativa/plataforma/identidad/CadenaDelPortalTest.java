...
class CadenaDelPortalTest {
            ...
            assertThat(DelPortal.SUJETO.get())
                    ...
                    .isEqualTo(
                            new DocumentoIdentidad(
                                    kamayuk.normativa.dominio.TipoDocumento.DNI, "03593174"));
        }
    ...
    static class ContextoDePrueba {
        ...
        org.springframework.boot.web.servlet.FilterRegistrationBean<
                        kamayuk.normativa.plataforma.tenant.TenantContextFilter>
                filtroDeTenant() {
            var registro =
                    new org.springframework.boot.web.servlet.FilterRegistrationBean<>(
                            new kamayuk.normativa.plataforma.tenant.TenantContextFilter());
            registro.setOrder(0);
            return registro;
        }
        ...
        @Bean
        org.springframework.boot.web.servlet.FilterRegistrationBean<
                        kamayuk.normativa.plataforma.tenant.DocumentoCiudadanoContextFilter>
                filtroDelCiudadano() {
            var registro =
                    new org.springframework.boot.web.servlet.FilterRegistrationBean<>(
                            new kamayuk.normativa.plataforma.tenant
    ...
    static class DelPortal {
        ...
        static final String RUTA = "/normativa/api/v1/portal/prueba";
    ...
    static class DeFuncionario {
        ...
        static final String RUTA = "/normativa/api/v1/prueba/municipalidad";
        static final AtomicInteger LLAMADAS = new AtomicInteger();
