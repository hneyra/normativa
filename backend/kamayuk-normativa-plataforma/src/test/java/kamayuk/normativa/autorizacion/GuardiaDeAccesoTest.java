...
import kamayuk.normativa.compartido.CiudadanoContext;
import kamayuk.normativa.dominio.DocumentoIdentidad;
...
class GuardiaDeAccesoTest {
    ...
    void elPrivilegioDelMetodoGana() throws Exception {
        ...
        mvc.perform(get("/normativa/api/v1/prueba/alta")).andReturn();
    ...
    void sesionPropiaPasaSinComprobarElCatalogo() throws Exception {
        ...
        MvcResult resultado = mvc.perform(get("/normativa/api/v1/prueba/sesion")).andReturn();
    ...
    void ciudadanoPasaSoloDesdeSuCadena() throws Exception {
        ...
        try {
            MvcResult resultado = mvc.perform(get("/normativa/api/v1/portal/prueba")).andReturn();
    ...
    void conSoloLaAlternativaPasa() throws Exception {
        ...
        MvcResult resultado = mvc.perform(get("/normativa/api/v1/prueba/dos-opciones")).andReturn();
    ...
    void laAlternativaNoRelajaElPrivilegio() throws Exception {
        ...
        mvc.perform(get("/normativa/api/v1/prueba/dos-opciones")).andReturn();
    ...
    void sinAccesoDeclaradoSeDeniega() throws Exception {
        ...
        MvcResult resultado = mvc.perform(get("/normativa/api/v1/prueba/sin-declarar")).andReturn();
    ...
    static class ControladorDePrueba {
        ...
        @GetMapping("/normativa/api/v1/prueba/consulta")
        String consultar() {
            return "ok";
        }

        @GetMapping("/normativa/api/v1/prueba/alta")
    ...
    static class ControladorSinDeclarar {
        ...
        @GetMapping("/normativa/api/v1/prueba/sin-declarar")
        String sinDeclarar() {
            return "ok";
        }
    }
    ...
    static class ControladorDeDosOpciones {
        ...
        @GetMapping("/normativa/api/v1/prueba/dos-opciones")
        String consultar() {
            return "ok";
        }
    }
    ...
    static class ControladorDeSesionPropia {
        ...
        @GetMapping("/normativa/api/v1/prueba/sesion")
        String sesion() {
            return "ok";
        }
    }
    ...
    static class ControladorDelCiudadano {
        ...
        @GetMapping("/normativa/api/v1/portal/prueba")
        String situacion() {
            return "ok";
        }
    }
