 ...
 *       kamayuk.normativa.web.ConfiguracionDeJson}, no la disciplina de quien escribe cada DTO.
 *   <li><b>Errores como {@code application/problem+json}</b> (RFC 9457), con un catalogo de codigos
 *       estable —{@link kamayuk.normativa.web.CodigoDeError}— para que la interfaz pueda reaccionar
