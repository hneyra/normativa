 ...
 *
 * <p>{@code kamayuk.normativa.web} vive en {@code kamayuk-normativa-plataforma}, que no depende —ni
 * debe— de {@code kamayuk-normativa-parametros}, que es un contexto acotado. Quien traduce la
