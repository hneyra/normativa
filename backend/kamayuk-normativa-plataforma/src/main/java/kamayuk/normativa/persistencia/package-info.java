 ...
 * compartido} y {@code dominio}, se declara modulo compartido en {@code SgtmAplicacion}: no es un
 * contexto acotado, y que cualquier contexto lo use no es una violacion de los limites sino su
 * proposito.
 *
