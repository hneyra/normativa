 ...
 * kamayuk.normativa.persistencia}, al lado de {@link OrdenSeguro} —la otra pieza que existe para
 * que doce contextos no inventen doce dialectos de lo mismo—. Repetirla una cuarta vez es como se
 * acaba colando un {@code LIKE} en la quinta.
 */
