 ...
 * kamayuk.normativa.autorizacion.RequiereAcceso}, asi que la anotacion y el enum tienen que estar
 * en un modulo que todos puedan importar. Si vivieran en {@code kamayuk-rentas-seguridad}, cada
 * contexto dependeria de el —lo que ARQ-01 admite— pero {@code kamayuk-rentas-seguridad} no podria
 * aplicar las mismas convenciones sin depender de si mismo.
 *
 * <p>De ahi el reparto: aqui el <b>contrato</b> —la anotacion, el enum y el puerto {@link
 * kamayuk.normativa.autorizacion.ComprobadorDeAcceso}—, y en {@code kamayuk-rentas-seguridad} la
