...
public interface ReglaTributaria {
    ...
    /**
     * De que lado de la frontera de ADR-0024 se aplica: valuacion u obligacion.
     *
     * <p>No tiene valor por omision <b>a proposito</b>: una regla que no lo declare no compila. Lo
     * comprueba {@link MotorDeReglas} al construirse, no al calcular, para que el error salga al
     * arrancar y no a mitad de una corrida de padron.
     */
    Ambito ambito();
