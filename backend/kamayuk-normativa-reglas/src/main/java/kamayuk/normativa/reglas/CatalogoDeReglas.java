...
public final class CatalogoDeReglas {
    ...
    /**
     * Todas las reglas por partida, de cualquier ejercicio.
     *
     * <p>Existe para que {@link MotorDeReglas} pueda revisar el <b>catalogo entero</b> al
     * construirse (ADR-0024): revisar solo las vigentes del ejercicio que se pide dejaria pasar una
     * regla de otro ambito hasta el dia en que ese ejercicio se calcule.
     */
    public List<ReglaTributaria> todasLasReglas() {
        return reglas;
    }

    /** Todas las de agregacion, por lo mismo. */
    public List<ReglaDeAgregacion> todasLasAgregaciones() {
        return agregaciones;
    }
