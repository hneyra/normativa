...
public interface ReglaDeAgregacion {
    ...
    /**
     * De que lado de la frontera de ADR-0024 se aplica. Mismo contrato que {@link
     * ReglaTributaria#ambito()}: obligatorio, sin valor por omision, y comprobado al construir el
     * motor.
     */
    Ambito ambito();
