...
/**
 * {@code normativa} sigue cumpliendo lo que {@code rentas} espera de el (ADR-0030 §4).
 *
 * <p>El contrato lo publica {@code rentas} —{@code
 * rentas/docs/50-api/contratos-que-consume/normativa.json}— derivado de lo que {@code
 ...
 */
@DisplayName("Contrato con rentas (normativa es el proveedor)")
