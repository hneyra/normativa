...
/**
 * {@code normativa} arranca. Los dos perfiles, con el artefacto de verdad.
 *
 ...
 *
 * <ul>
 *   <li>Quitandole al modulo {@code kamayuk-normativa-seguridad} el {@code ComprobadorDeAccesoJdbc}
...
@DisplayName("C-7 — normativa arranca, en los dos perfiles")
class ArranqueDeLaAplicacionTest {
    ...
    void elPerfilWebLevanta(org.springframework.context.ApplicationContext contexto) {
        assertThat(contexto.getBeanNamesForType(SnapshotController.class))
                .as("quien serializa el snapshot sellado y calcula su ETag")
                .isNotEmpty();
