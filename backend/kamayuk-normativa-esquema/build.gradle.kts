// kamayuk-normativa-esquema no es un contexto acotado: contiene las migraciones Flyway, el
...
// reutiliza kamayuk-normativa-plataforma para su prueba con el pool real. Un segundo arranque
...
application {
    mainClass.set("kamayuk.normativa.esquema.Migrador")
