...
| **El ejercicio 2026** | **SELLADO desde el 2026-09-06.** 33 filas del derivado del corpus y los dos cuadros de la valuación, 35 detalles compuestos. Lo que faltaba no era una cifra sino la segunda firma de ADR-0007 sobre el `% actualización` — y su intervalo tuvo precio medido: mientras duró, `catastro` valorizó **0 de 23** predios; hoy valoriza **4 de 23**, y los otros 19 esperan a **RT-004**, que es otra decisión |
