...
| 33 | **El `% actualización` del predial**: qué es, quién lo fija y con qué valor. Multiplica el autovalúo antes del `% propiedad`, era el último de los cuatro factores de D-11 sin fuente, y desde el 2026-09-06 la tiene | **TUO LTM art. 12**, confirmado como tal en §1.4 del archivo: es el único porcentaje de actualización de la base imponible del predial que ese TUO contiene. Se descartó el art. 14 —la actualización de valores de la emisión mecanizada— contra los manuales del SRTM del MEF: ahí ese acto es una **redeterminación** con las tablas del ejercicio nuevo, no un porcentaje. El art. 12 no fija una cifra sino un **supuesto** —que en el ejercicio no se publiquen los aranceles ni los valores unitarios—, de modo que la fila se resuelve **ejercicio a ejercicio y no se hereda**: para **2026** el supuesto no se cumple (se publicaron los dos, RM 514-2025-EF/15 y RM 277-2025-VIVIENDA), la fila vale `0` y está publicada con sus dos firmas; **ningún otro ejercicio tiene fila**, y el de 2027 no puede tenerla hasta que sus resoluciones se publiquen (`predial-porcentaje-de-actualizacion.md` §1.6 y §1.6.2) | D-02a | ninguno todavía — la etiqueta de bloqueo no le corresponde (§2.8 lista los que llevan `bloqueado:D-02`, y esto no es una decisión de D-02 sino una búsqueda de fuente abierta). Lo que sí espera son `RT-002`, `RT-005` y `RT-011`, que no se implementan ni estructuralmente. La fila de 2026 desbloquea la **valuación** de `catastro`, que pasa de 0 a 4 de 23 predios del padrón de demostración |
