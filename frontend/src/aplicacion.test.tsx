...
/**
 * La prueba vive JUNTO al codigo (AC6). No comprueba una pantalla —no hay ninguna—: prueba
...
describe('el casco de normativa-web', () => {
  it('monta y anuncia el sistema por su encabezado', () => {
    ...
    expect(screen.getByRole('heading', { level: 1, name: 'Normativa' })).toBeInTheDocument();
  });
});
