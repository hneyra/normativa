 ...
 * codigo distinta. Aqui no ha pasado nunca lo que cuenta la historia de abajo, y es porque el stack
 * se trajo entero de `rentas` en #115: esta guarda es la que impide que eso deje de ser verdad el
 * dia que la libreria pida una octava.
 *
 * <h2>El defecto que esto habria cazado, y que se descubrio a mano</h2>
 *
 * `@kamayuk/ui` se mezclo tres veces —#6, #8, `rentas`#11— declarando `peerDependencies` que su unico
