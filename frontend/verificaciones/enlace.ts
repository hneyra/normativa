 ...
 *
 * **Calcado de `rentas/frontend/verificaciones/enlace.ts` en `ac379ac`** (#55): no hay una linea de
...
/**
 * **Lo que un paquete enlazado pide por `peerDependencies`, o un rojo que dice donde mirar** (`rentas`#113).
 *
