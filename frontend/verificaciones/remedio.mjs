/**
 * **El rojo que nombra el `git clone`, en `.mjs` para que lo pueda leer tambien ESLint** (`rentas`#137).
 *
 ...
 * TypeScript**: desde `rentas`#137 `eslint.config.js` carga `eslint.prohibiciones.mjs`, que importa
 ...
 * `enlace.ts`, y es el hallazgo de `rentas`#113: `yarn install --frozen-lockfile` con el hermano ausente
 ...
 * nadie llegue a preguntar por este directorio (`rentas`#113), y `eslint.prohibiciones.mjs` cuando el
...
export function remedioDelEnlace(paquete, declarada) {
  ...
  return clon === null
    ...
    : `Este frontend NO funciona sin «${clon}» clonado al lado de «normativa»:\n` +
