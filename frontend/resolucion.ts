 ...
 *
 * **Calcado de `rentas/frontend/resolucion.ts` en `ac379ac`** (`normativa`#55): no hay una linea de
 * codigo distinta, y los `#N` de la prosa son de `rentas`, que es donde se midieron.
 *
 ...
 * nunca** en el unico caso para el que se escribio (`rentas`#113)—. El mensaje entero, con el
 * paquete que no resolvio y la ruta donde se le espera, lo compone `loQuePideElEnlace`.
 */
